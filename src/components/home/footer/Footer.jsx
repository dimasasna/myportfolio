...
const Footer = () => {
  ...
  return (
    <section id='footer' className='w-[100%] lg:h-[35vh] h-[60vh] bg-[#181818] flex flex-col justify-center items-center gap-6 px-4 lg:px-0 '>
      <div className='flex justify-center items-center text-2xl lg:text-4xl tracking-tighter font-bold uppercase text-primary -mt-24 lg:-mt-0 max-w-auto -ml-5 lg:-ml-0'>
          <Lottie className="lg:h-[100px] h-14" animationData={mail} />
